$(document).ready(function() {
    ...
    document.getElementsByClassName('header_menu_items')[0].addEventListener('click' , () => {
        $('.header_menu_items_deployed_vertion')[0].classList.toggle('active')
    });

    document.getElementsByClassName('header_menu_items')[1].addEventListener('click' , () => {
        $('.header_menu_items_deployed_vertion')[1].classList.toggle('active')
    });

    document.getElementsByClassName('header_menu_items')[2].addEventListener('click' , () => {
        $('.header_menu_items_deployed_vertion')[2].classList.toggle('active')
    });

    document.getElementsByClassName('header_menu_items')[3].addEventListener('click' , () => {
        $('.header_menu_items_deployed_vertion')[3].classList.toggle('active')
    });

    document.getElementsByClassName('header_menu_items')[4].addEventListener('click' , () => {
        $('.header_menu_items_deployed_vertion')[4].classList.toggle('active')
    });

    document.getElementsByClassName('header_menu_items')[5].addEventListener('click' , () => {
